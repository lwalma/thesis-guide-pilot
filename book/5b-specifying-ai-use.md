...
When you use texts generated by AI tools (such as Chat GPT or Copilot) it is important to mention this in your work. Depending on your program, there are different ways the use of AI is allowed and how you should report it. The formats in this guide are here to help you think about how to report uses of AI, but you should always check with your program what specific policies are in place for genAI use.
...
```{admonition} Careful
:class: caution
You are responsible for your uses of AI. Critically evaluate its output and don't put any confidential or proprietary information in the models.
```

## Step 3: Report the uses of GenAI in Your Thesis

If GenAI use is allowed by your supervisor, you should acknowledge throughout your thesis how you used it. One reason is that it makes your work more transparant. In addition, should you aim to publish your research academic journals will also ask for this. 
